                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="bg-gray-100 p-6">
                            ...
                            <div className="mb-4">
                                <input type="text" placeholder="First Name" className="contact-input w-full py-2 pl-2" />
                            </div>
                            <div className="mb-4">
                                <input type="text" placeholder="Last Name" className="contact-input w-full py-2 pl-2" />
                            </div>
                            <div className="mb-4">
                                <input type="text" placeholder="Phone Number" className="contact-input w-full py-2 pl-2" />
                            </div>
                            <div className="mb-4">
                                <input type="email" placeholder="Email" className="contact-input w-full py-2 pl-2" />
                            </div>
                            <div className="mb-4">
                                <textarea name="message" cols="30" placeholder="Message" rows="5"
                                    className="contact-input w-full pl-2"></textarea>
                            </div>
